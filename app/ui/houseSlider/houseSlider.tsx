...
export default function HouseSlider(): ReactElement {
  const houseCards: IHouseCard[] = [
    ...
    },
    {
      ...
      description:
        "Аутентичные видовые дома с панорамными окнами и верандами. Оснащены всем необходимым для комфортного проживания: теплые полы и кондиционеры, видовая кухня-гостиная, 2 спальни с кроватями king-size и Box Spring, телевизор.",
      roomType: "433999",
    },
  ];
